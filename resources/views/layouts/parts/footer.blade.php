    ...
    <footer>
        <div class="row justify-content-center">
          <div class="col-3">
            ...
            <a href="https://instagram.com/kamarpelajar" target="_blank" > <img class="mb-2" src="{{URL::to('images/icons/ig.png')}}" alt=""  height="24"></a>
            <a href="https://wa.me/62811158860" target="_blank" >  <img class="mb-2" src="{{URL::to('images/icons/wa.png')}}" alt=""  height="24"></a>
            <a href="mailto:mimin@kamarpelajar.com" target="_blank" >  <img class="mb-2" src="{{URL::to('images/icons/gmail.png')}}" alt=""  height="24"></a>
          </div>
          <div class="col-3">
            <h5>Tentang kami</h5>
